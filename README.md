# NegroGringo NodeJS x Express API

Watch out for the snakes. Cut the grass.

## Manual Installation

- `git clone https://github.com/NegroGringo/negrogringo-express.git`
- `cd negrogringo-express`
- `pnpm install`
...
- [Features](https://github.com/NegroGringo/negrogringo-express#features)
- [Environment Variables](https://github.com/NegroGringo/negrogringo-express#environment-variables)
- [Project Structure](https://github.com/NegroGringo/negrogringo-express#project-structure)
- [API Documentation](https://github.com/NegroGringo/negrogringo-express#api-documentation)
- [Error Handling](https://github.com/NegroGringo/negrogringo-express#error-handling)
- [Validation](https://github.com/NegroGringo/negrogringo-express#validation)
- [Authentication](https://github.com/NegroGringo/negrogringo-express#authentication)
- [Authorization](https://github.com/NegroGringo/negrogringo-express#authorization)
- [Logging](https://github.com/NegroGringo/negrogringo-express#logging)
- [Author](https://github.com/NegroGringo/negrogringo-express#author)
